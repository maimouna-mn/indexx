...
<body> 
   <form action="enregistrementE.php" method="POST"> 
...
<div class="container">  
<a class="btn btn-primary btn1" href="enregistrementE.php" role="button">Ajouter</a>
  ...
  <tbody>
    <?php foreach ($donnees_assoc as $donnees) { ?>
      <tr>
        ...
        <td style="width: 20%;"><?php echo $donnees['prenom']; ?></td>
        <td style="width: 20%;"><?php echo $donnees['nom']; ?></td>
        <td style="width: 20%;"><?php echo $donnees['datenaiss']; ?></td>
        <td style="width: 20%;"><?php echo $donnees['status']; ?></td>
        <td class="user-link"><?php echo $donnees['matricule']; ?></td>
		<td style="width: 20%;">
